...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        service_factory = ServiceFactory(
            ...
            model_checkpoint=r"D:\FInal_AIC\Image-Retrieval-System-for-AIC2025\beit3\beit3_large_patch16_384_f30k_retrieval.pth",  # Thay bằng đường dẫn thực tế
            tokenizer_checkpoint=r"D:\FInal_AIC\Image-Retrieval-System-for-AIC2025\beit3\beit3.spm",  # Thay bằng đường dẫn thực tế
            es_client=es_client, # Truyền ES client
            es_ocr_index_name=es_settings.ES_OCR_INDEX,
